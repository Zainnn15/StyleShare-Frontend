...
const GARMENT_TYPES = [
    ...
    { cat: 'Top', value: 'sweater', label: 'Sweater or Pullover (usually made of knitted or crocheted material)' },
    ...
    { cat: 'Top', value: 'jacket', label: 'Jacket (for the upper body, usually extending below the hips, usually for outerwear)' },
    { cat: 'Top', value: 'coat', label: 'Coat (longer than a jacket, usually outerwear, for example, a trench coat)' },
    { cat: 'Top', value: 'rainJacket', label: 'Rain Jacket' },
    { cat: 'Bottom', value: 'pants', label: 'Pants (more casual can vary in length, for example, cargo pants)' },
    { cat: 'Bottom', value: 'trouser', label: 'Trouser (more formal and covers the entire lower body from the waist to the ankles)' },
