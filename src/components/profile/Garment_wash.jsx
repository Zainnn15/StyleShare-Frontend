...
import { formatTemp } from '../../constants/functions/valueHandlers';
import '../../styles/main.scss';
import InfoPopup from '../common/InfoPopup';

const Garment_wash = ({garment}) => {
    const care = garment.washCareInstructions;
    return(
        <div className="m1">
            <label className="container-subtitle-2">{care.washDate}</label>
