...
const Garment_feel = ({garment}) => {
    return(
        <div className="m1">
            {
                garment && garment.garmentFeels.map((feel)=>{
                return (
                    <div key={feel._id}>
                        ...
                        <div className="container-grid-2-md gap container-border clear-box">
                            ...
                            <div>
                                ...
                                {
                                    (feel.feelHasComment === 'Positive comments' || 
                                    feel.feelHasComment === 'Negative comments') && (
                                    <div>
                                        <p>
