    ...
    <div>
      ...
      <div className="container main">
        ...
        <form onSubmit={sendGarmentDetails}>
                    ...
                    <div>
                      ...
                      >
                        <img
                          ...
                          src={
                            twistingImg
                              ? URL.createObjectURL(twistingImg)
                              : selectImg
                          }
                          alt="upload photo"
                        />
                      ...
                      <div className="container-input">
                        <input
                          id="twistingImg"
                          type="file"
                          onChange={(e) => setTwistingImg(e.target.files[0])}
                          required
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      >
                        <img
                          ...
                          src={
                            spandexShrinkImg
                              ? URL.createObjectURL(spandexShrinkImg)
                              : selectImg
                          }
                          alt="upload photo"
                        />
                      ...
                      <div className="container-input">
                        <input
                          ...
                          type="file"
                          onChange={(e) =>
                            setSpandexShrinkImg(e.target.files[0])
                          }
                          required
                        />
                      </div>
                    ...
                    <div>
                      ...
                      >
                        <img
                          ...
                          src={
                            printFadeImg
                              ? URL.createObjectURL(printFadeImg)
                              : selectImg
                          }
                          alt="upload photo"
                        />
                      ...
                      <div className="container-input">
                        <input
                          id="printFadeImg"
                          type="file"
                          onChange={(e) => setPrintFadeImg(e.target.files[0])}
                          required
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      >
                        <img
                          id="holeImg_img"
                          src={
                            holeImg ? URL.createObjectURL(holeImg) : selectImg
                          }
                          alt="upload photo"
                        />
                      </div>
                      ...
                      <div className="container-input">
                        <input
                          id="holeImg"
                          type="file"
                          onChange={(e) => setHoleImg(e.target.files[0])}
                          required
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="container-radio">
                        <div className="container-radio-group">
                          <input
                            type="radio"
                            id="stainSourceKnow_yes"
                            name="stainSourceKnow"
                            value={1}
                            onClick={(e) => {
                              setTearExtra({
                                ...tearExtra,
                      ...
                      >
                        <img
                          id="stainImg_img"
                          src={
                            stainImg ? URL.createObjectURL(stainImg) : selectImg
                          }
                          alt="upload photo"
                        />
                      </div>
                      ...
                      <div className="container-input">
                        <input
                          id="stainImg"
                          type="file"
                          onChange={(e) => setStainImg(e.target.files[0])}
                          required
                        />
                      </div>
                    </div>
          ...
          <div className="container-content">
            <label className="text-b clickable" htmlFor="wantRepair">
              Require garment repair?
            </label>
            <input
              type="checkbox"
              id="wantRepair"
