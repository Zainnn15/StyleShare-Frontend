...
export default function Group() {
    ...
    useEffect(() => {
        if (tabPage === 1) {
            const ChatDivArr = document.getElementsByClassName('container-chat-history');
            if(ChatDivArr.length > 0) {
                const height = ChatDivArr[0].scrollHeight;
                                            ...
                                            <div key={member._id} className="member-garments">
                                                <div className='container-border clickable' onClick={()=>{navigate("/garment-exchange")}}>
                                                    <p className='center text-midLg'>
                                                        ...
                                                        {member.username === user.username && <label> (You)</label>}
                                                    </p>
                                                    <div className='container-col'>
                                                        <div className='container-profile-img'>
                                                            <img src={member.profilePicture ? getImageFromURL(member.profilePicture) : defaultProfile} alt="Profile"/>
                                                        </div>
                                                    </div>
                                                    <br/>
